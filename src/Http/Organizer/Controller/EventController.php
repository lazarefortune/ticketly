...
class EventController extends CrudController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('organizer_event_edit', ['id' => $event->getId()]);
        }

        return $this->render('pages/organizer/event/new.html.twig', [
    ...
    public function edit(Event $event, Request $request): Response
    {
        ...
        return $this->render('pages/organizer/event/edit.html.twig', [
            'form' => $form->createView(),
            'event' => $event,
        ]);
    }
    ...
    ): Response
    {
        ...
        return $this->render('pages/organizer/event/overview.html.twig', [
            'event' => $event,
            'nbTickets' => $nbTickets,
    ...
    public function reservations(Event $event, ReservationRepository $reservationRepository): Response
    {
        ...
        return $this->render('pages/organizer/event/reservations.html.twig', [
            'event' => $event,
    ...
    public function collaborations(Event $event, InvitationRepository $invitationRepository): Response
    {
        ...
        return $this->render('pages/organizer/event/collaborators.html.twig', [
            'event' => $event,
    ...
    public function coupons(Event $event, CouponRepository $couponRepository): Response
    {
        ...
        return $this->render('pages/organizer/event/coupons.html.twig', [
            'event' => $event,
            'coupons' => $coupons,
        ]);
    }
