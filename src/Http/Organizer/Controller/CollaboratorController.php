...
class CollaboratorController extends AbstractController
{
    ...
    public function invite(Event $event, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('organizer_event_collaborators_invite', ['id' => $event->getId()]);
        }

        return $this->render('pages/organizer/event/collaborators/invite_collaborator.html.twig', [
    ...
    public function modify(Event $event, User $collaborator, Request $request): Response
    {
        ...
        if (!$eventCollaborator) {
            ...
            return $this->redirectToRoute('organizer_event_collaborators', ['id' => $event->getId()]);
        }
        ...
        return $this->render('pages/organizer/event/collaborators/modify_roles.html.twig', [
            'form' => $form->createView(),
            'event' => $event,
