...
class CouponController extends CrudController
{
    ...
    protected string $routePrefix = 'dashboard_event_coupon';
    ...
    public function new(Request $request, Event $event): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('dashboard_event_coupons', ['id' => $event->getId()]);
        }

        return $this->render('dashboard/coupons/new.html.twig', [
    ...
    public function edit(Coupon $coupon, Request $request): Response
    {
        ...
        return $this->render('dashboard/coupons/edit.html.twig', [
            'form' => $form->createView(),
            'event' => $event,
        ]);
    }
    ...
    public function changeType(Request $request): Response
    {
        ...
        return $this->render( 'dashboard/coupons/blocs/_coupon_value.html.twig', [
            'form' => $form->createView(),
        ] );
    }
}